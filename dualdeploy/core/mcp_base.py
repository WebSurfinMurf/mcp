    ...
    def handle_tools_call(self, params: Dict, request_id: Optional[int] = None) -> Dict:
        ...
        if "result" in result:
            ...
            return self.wrap_json_rpc_response({
                "content": [{"type": "text", "text": json.dumps(tool_result, cls=DateTimeEncoder)}]
            }, request_id)
    ...
    def run_stdio_mode(self):
        ...
        for line in sys.stdin:
            ...
            try:
                ...
                print(json.dumps(response, cls=DateTimeEncoder), flush=True)
                
            except json.JSONDecodeError as e:
                self.logger.error(f"Invalid JSON received: {e}")
                error_response = self.wrap_json_rpc_error(-32700, "Parse error")
                print(json.dumps(error_response, cls=DateTimeEncoder), flush=True)
            except Exception as e:
        ...
        async def sse_endpoint():
            ...
            async def event_generator():
                ...
                while True:
                    ...
                    yield f"event: {heartbeat['event']}\ndata: {json.dumps(heartbeat['data'], cls=DateTimeEncoder)}\n\n"
